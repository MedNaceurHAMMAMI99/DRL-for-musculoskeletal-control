...
The cause was a setting called \textbf{target entropy}, which controls how much
deliberate randomness the learner keeps in its actions. Randomness helps early ---
it is how the agent discovers what works. It must fade for the hand to hold
still. The software's default sets it in proportion to the number of muscles,
and for nine muscles that default keeps roughly twice as much randomness as this
task tolerates.

\textbf{The hand was being deliberately jiggled and could not settle.}

\lesson{A default value is a guess made by someone who had not seen your problem.
This one produced a failure that looked like insufficient training --- and
survived every attempt to fix it as though it were.}
...
\textbf{For \emph{how much} force: not yet.} It uses about 1.9 times the minimum-effort ideal --- and, more meaningfully,
about 44\,\% more than a conventional controller actually achieves on the same
task --- concentrated in one pair of opposing elbow muscles.
