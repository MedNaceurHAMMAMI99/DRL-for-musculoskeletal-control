...
\midrule
\textbf{average} & \textbf{0.1074} & \textbf{0.0734} & \textbf{1.91} & 8\,\% \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
1 (original) & $1.91\times$ & 0.81 & 0.1074 \\
5 & $1.41\times$ & 0.92 & 0.1114 \\
\textbf{20} & $\mathbf{1.30\times}$ & \textbf{0.94} & 0.1161 \\
\bottomrule
\end{tabular}
\end{table}

The waste fell steadily and agreement with the classical answer rose steadily.
Accuracy did suffer, but only slightly: the final distance grew by about 8\,\%
across the whole range, while the closest the hand ever got did not change at
all. So the controller became no worse at \emph{reaching} the target --- only
slightly worse at \emph{staying} there.
