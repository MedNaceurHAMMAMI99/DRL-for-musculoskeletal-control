...
Two secondary results follow. Library-default hyperparameters imposed an error
plateau that persisted through three reward redesigns; optimisation halved the
reaching error, though a subsequent ablation refuted the initial attribution of
this to the exploration temperature. And tuning proved to dominate
