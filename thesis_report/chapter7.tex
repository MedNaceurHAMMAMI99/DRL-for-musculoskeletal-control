...
\textbf{This is the weakest of the three convergent analyses}, and it should be
weighted accordingly. The effort ratio (five seeds, non-overlapping
distributions) and the co-contraction index are far better determined than the
synergy comparison, which rests on a statistic whose sampling spread is
comparable to the effect it measures. The three analyses do order the
configurations consistently, but only two of them do so with confidence.
