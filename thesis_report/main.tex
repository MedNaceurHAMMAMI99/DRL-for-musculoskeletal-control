...
\mainmatter
\input{chapter1}   % General Introduction
\input{chapter2}   % State of the Art
\input{chapter3}   % Modelling and Simulation Environment
\input{chapter4}   % Theoretical Framework of DRL
\input{chapter5}   % Implementation and Experimental Methodology
\input{chapter6}   % Experimental Results and Analysis
\input{chapter7}   % Load-Sharing Fidelity vs Classical Calculation
\input{chapter8}   % Discussion
...
{\sloppy\printbibliography[title={Bibliography}, heading=bibintoc]\par}
