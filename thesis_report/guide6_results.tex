...
The prediction held, in every particular.

\textbf{Fidelity improves monotonically}, and the distributions are cleanly
separated --- every $w_2 = 20$ seed (1.278--1.340) lies below every $w_2 = 5$ seed
(1.336--1.557), which lies below every $w_2 = 1$ seed (1.710--2.116). Per-muscle
RMSE falls from 10.1\,\% to about 3\,\% of mean $F_{\max}$.
