...
\begin{enumerate}
  ...
  \item \textbf{End-point variance minimization}~\parencite{Harris1998}: neural
...
computation amortized into a one-time training phase.''} That hypothesis was
...
action) varies with fiber length according to the constant-thickness
...
leading entries. \textcite{Song2021} extend this approach to modeling human locomotion
