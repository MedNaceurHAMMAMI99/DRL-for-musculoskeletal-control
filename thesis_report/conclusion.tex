...
learned and classical modular organisation rises as the policy improves --- from
$0.676 \pm 0.054$ to $0.851 \pm 0.129$ on resampling --- and that the classical
solution is uniformly the more low-dimensional of the two, requiring four to five
synergies where the learned policies require six to nine. This is the least
well-determined of the three analyses: the synergy statistic's sampling spread is
comparable to the effect it measures (\cref{sec:synergies}), and the ordering
survives while the magnitude should not be pressed. That the same hyperparameter change improved
