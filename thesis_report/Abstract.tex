...
at no measurable cost in reaching accuracy, and comparable to the $1.33$ attained
by a conventional controller solving the same problem explicitly. The excess is anatomically localised: the
